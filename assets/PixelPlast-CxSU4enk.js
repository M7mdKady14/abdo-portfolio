...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Da(e,t,n){let r=new Float32Array(pa),i=new K(0,1,0);return new ai({name:`SphericalGaussianBlur`,defines:{n:pa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oa(){return new ai({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ka(){return new ai({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
...
`)}var rs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function is(e,t){let n=rs[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var as=new K;function os(){return J.getLuminanceCoefficients(as),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${as.x.toFixed(4)}, ${as.y.toFixed(4)}, ${as.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
#endif
#include <dithering_fragment>
}`,Bc=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,Vc=class extends ai{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`184`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new Xi(null),depthBuffer:new Xi(null),resolution:new Xi(new G),texelSize:new Xi(new G),cameraNear:new Xi(.3),cameraFar:new Xi(1e3),aspect:new Xi(1),time:new Xi(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=Ie){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=zc.replace(Q.FRAGMENT_HEAD,e.get(Q.FRAGMENT_HEAD)||``).replace(Q.FRAGMENT_MAIN_UV,e.get(Q.FRAGMENT_MAIN_UV)||``).replace(Q.FRAGMENT_MAIN_IMAGE,e.get(Q.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=Bc.replace(Q.VERTEX_HEAD,e.get(Q.VERTEX_HEAD)||``).replace(Q.VERTEX_MAIN_SUPPORT,e.get(Q.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof Mi?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Q}};Number(`184`.replace(/\D+/g,``));var Hc=255/256;new Float32Array([Hc/256**3,Hc/256**2,Hc/256,Hc]),new Float32Array([Hc,Hc/256,Hc/256**2,1/256**3]);function Uc(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function Wc(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&jc.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Q.FRAGMENT_HEAD)||``,u=c.get(Q.FRAGMENT_MAIN_UV)||``,d=c.get(Q.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Q.VERTEX_HEAD)||``,p=c.get(Q.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
`,n.uvTransformation=!0),i!==null&&/mainSupport/.test(i)){let t=/mainSupport *\([\w\s]*?uv\s*?\)/.test(i);p+=`	${e}MainSupport(`,p+=t?`vUv);
`:`);
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);Uc(e,h,n.defines),Uc(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=Ie){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){switch(e.type){case`change`:this.recompile();break}}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),qc(0,0,0,0),new Float32Array([0,0,0,0]),qc(0,0,0,1),new Float32Array([0,0,0,1]),qc(0,0,1,0),new Float32Array([0,0,1,0]),qc(0,0,1,1),new Float32Array([0,0,1,1]),qc(0,1,0,0),new Float32Array([0,1,0,0]),qc(0,1,0,1),new Float32Array([0,1,0,1]),qc(0,1,1,0),new Float32Array([0,1,1,0]),qc(0,1,1,1),new Float32Array([0,1,1,1]),qc(1,0,0,0),new Float32Array([1,0,0,0]),qc(1,0,0,1),new Float32Array([1,0,0,1]),qc(1,0,1,0),new Float32Array([1,0,1,0]),qc(1,0,1,1),new Float32Array([1,0,1,1]),qc(1,1,0,0),new Float32Array([1,1,0,0]),qc(1,1,0,1),new Float32Array([1,1,0,1]),qc(1,1,1,0),new Float32Array([1,1,1,0]),qc(1,1,1,1),new Float32Array([1,1,1,1]);function Kc(e,t,n){return e+(t-e)*n}function qc(e,t,n,r){return Kc(Kc(e,t,.75),Kc(n,r,.75),.875)}var Jc=t(e(),1),Yc=n(),Xc=()=>{let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`);if(!t)throw Error(`2D context not available`);t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height);let n=new Dt(e);n.minFilter=l,n.magFilter=l,n.generateMipmaps=!1;let r=[],i=null,a=.1*64,o=()=>{t.fillStyle=`black`,t.fillRect(0,0,e.width,e.height)},s=e=>{let n={x:e.x*64,y:(1-e.y)*64},r;r=e.age<64*.3?(e=>Math.sin(e*Math.PI/2))(e.age/(64*.3)):(e=>-e*(e-2))(1-(e.age-64*.3)/(64*.7))||0,r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${r*255}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=a,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(255,0,0,1)`,t.arc(n.x-320,n.y-320,a,0,Math.PI*2),t.fill()};return{canvas:e,texture:n,addTouch:e=>{let t=0,n=0,a=0;if(i){let r=e.x-i.x,o=e.y-i.y;if(r===0&&o===0)return;let s=r*r+o*o,c=Math.sqrt(s);n=r/(c||1),a=o/(c||1),t=Math.min(s*1e4,1)}i={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:n,vy:a})},update:()=>{o();for(let e=r.length-1;e>=0;e--){let t=r[e],n=t.force*.015625*(1-t.age/64);t.x+=t.vx*n,t.y+=t.vy*n,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)s(r[e]);n.needsUpdate=!0},set radiusScale(e){a=.1*64*e},get radiusScale(){return a/(.1*64)},size:64}},Zc=(e,t)=>new Lc(`LiquidEffect`,`
    ...
    `,{uniforms:new Map([[`uTexture`,new Xi(e)],[`uStrength`,new Xi(t?.strength??.025)],[`uTime`,new Xi(0)],[`uFreq`,new Xi(t?.freq??4.5)]])}),Qc={square:0,circle:1,triangle:2,diamond:3},$c=`
void main() {
  gl_Position = vec4(position, 1.0);
}
`,el=`
...
`,tl=10;function nl(){let e=window.devicePixelRatio||1,t=window.matchMedia(`(pointer: coarse)`).matches;return Math.min(e,t?1:1.5)}function rl(){return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches?1e3/15:window.matchMedia(`(pointer: coarse)`).matches?1e3/30:1e3/45}var il=({variant:e=`square`,pixelSize:t=3,color:n=`#B497CF`,className:r,style:i,antialias:a=!0,patternScale:o=2,patternDensity:s=1,liquid:c=!1,liquidStrength:l=.1,liquidRadius:u=1,pixelSizeJitter:d=0,enableRipples:f=!0,rippleIntensityScale:p=1,rippleThickness:m=.1,rippleSpeed:h=.3,liquidWobbleSpeed:g=4.5,autoPauseOffscreen:_=!0,speed:v=.5,transparent:y=!0,edgeFade:b=.5,noiseAmount:x=0})=>{let S=(0,Jc.useRef)(null),C=(0,Jc.useRef)({visible:!0}),w=(0,Jc.useRef)(v),T=(0,Jc.useRef)(null),E=(0,Jc.useRef)(null);return(0,Jc.useEffect)(()=>{let e=S.current;if(!e||!_)return;let t=new IntersectionObserver(([e])=>{C.current.visible=e.isIntersecting},{rootMargin:`150px 0px`,threshold:0});return t.observe(e),()=>t.disconnect()},[_]),(0,Jc.useEffect)(()=>{let r=S.current;if(!r)return;w.current=v;let i=[`antialias`,`liquid`,`noiseAmount`],D={antialias:a,liquid:c,noiseAmount:x},O=!1;if(!T.current)O=!0;else if(E.current){for(let e of i)if(E.current[e]!==D[e]){O=!0;break}}if(O){if(T.current){let e=T.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),T.current=null}let i=new gc({canvas:document.createElement(`canvas`),antialias:a,alpha:!0,powerPreference:`high-performance`});i.domElement.style.width=`100%`,i.domElement.style.height=`100%`,i.setPixelRatio(nl()),r.appendChild(i.domElement),y?i.setClearAlpha(0):i.setClearColor(0,1);let v={uResolution:{value:new G(0,0)},uTime:{value:0},uColor:{value:new Y(n)},uClickPos:{value:Array.from({length:tl},()=>new G(-1,-1))},uClickTimes:{value:new Float32Array(tl)},uShapeType:{value:Qc[e]??0},uPixelSize:{value:t*i.getPixelRatio()},uScale:{value:o},uDensity:{value:s},uPixelJitter:{value:d},uEnableRipples:{value:+!!f},uRippleSpeed:{value:h},uRippleThickness:{value:m},uRippleIntensity:{value:p},uEdgeFade:{value:b}},S=new gn,E=new Ni(-1,1,1,-1,0,1),D=new ai({vertexShader:$c,fragmentShader:el,uniforms:v,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:Ue}),O=new Nr(new Xr(2,2),D);S.add(O);let k=new Zi,A=()=>{let e=r.clientWidth||1,n=r.clientHeight||1;i.setPixelRatio(nl()),i.setSize(e,n,!1),v.uResolution.value.set(i.domElement.width,i.domElement.height),T.current?.composer&&T.current.composer.setSize(i.domElement.width,i.domElement.height),v.uPixelSize.value=t*i.getPixelRatio()};A();let ee=new ResizeObserver(A);ee.observe(r);let te=(()=>{if(typeof window<`u`&&window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/4294967295}return Math.random()})()*1e3,j,ne,M;if(c){ne=Xc(),ne.radiusScale=u,j=new Ac(i);let e=new Rc(S,E);M=Zc(ne.texture,{strength:l,freq:g});let t=new Gc(E,M);t.renderToScreen=!0,j.addPass(e),j.addPass(t)}if(x>0){j||(j=new Ac(i),j.addPass(new Rc(S,E)));let e=new Gc(E,new Lc(`NoiseEffect`,`uniform float uTime; uniform float uAmount; float hash(vec2 p){ return fract(sin(dot(p, vec2(127.1,311.7))) * 43758.5453);} void mainUv(inout vec2 uv){} void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){ float n=hash(floor(uv*vec2(1920.0,1080.0))+floor(uTime*60.0)); float g=(n-0.5)*uAmount; outputColor=inputColor+vec4(vec3(g),0.0);} `,{uniforms:new Map([[`uTime`,new Xi(0)],[`uAmount`,new Xi(x)]])}));e.renderToScreen=!0,j&&j.passes.length>0&&j.passes.forEach(e=>{let t=e;t.renderToScreen=!1}),j.addPass(e)}j&&j.setSize(i.domElement.width,i.domElement.height);let N=e=>{let t=i.domElement.getBoundingClientRect(),n=i.domElement.width/t.width,r=i.domElement.height/t.height;return{fx:(e.clientX-t.left)*n,fy:(t.height-(e.clientY-t.top))*r,w:i.domElement.width,h:i.domElement.height}};i.domElement.addEventListener(`pointerdown`,e=>{let{fx:t,fy:n}=N(e),r=T.current?.clickIx??0;v.uClickPos.value[r].set(t,n),v.uClickTimes.value[r]=v.uTime.value,T.current&&(T.current.clickIx=(r+1)%tl)},{passive:!0}),i.domElement.addEventListener(`pointermove`,e=>{if(!ne)return;let{fx:t,fy:n,w:r,h:i}=N(e);ne.addTouch({x:t/r,y:n/i})},{passive:!0});let re,ie=0,ae=rl(),oe=(e=0)=>{if(_&&!C.current.visible){re=requestAnimationFrame(oe);return}if(e-ie<ae){re=requestAnimationFrame(oe);return}if(ie=e,v.uTime.value=te+k.getElapsedTime()*w.current,M){let e=M.uniforms.get(`uTime`);e&&(e.value=v.uTime.value)}j?(ne&&ne.update(),j.passes.forEach(e=>{let t=e;t.effects&&t.effects.forEach(e=>{let t=e.uniforms?.get(`uTime`);t&&(t.value=v.uTime.value)})}),j.render()):i.render(S,E),re=requestAnimationFrame(oe)};re=requestAnimationFrame(oe),T.current={renderer:i,scene:S,camera:E,material:D,clock:k,clickIx:0,uniforms:v,resizeObserver:ee,raf:re,quad:O,timeOffset:te,composer:j,touch:ne,liquidEffect:M}}else{let r=T.current;if(r.uniforms.uShapeType.value=Qc[e]??0,r.uniforms.uPixelSize.value=t*r.renderer.getPixelRatio(),r.uniforms.uColor.value.set(n),r.uniforms.uScale.value=o,r.uniforms.uDensity.value=s,r.uniforms.uPixelJitter.value=d,r.uniforms.uEnableRipples.value=+!!f,r.uniforms.uRippleIntensity.value=p,r.uniforms.uRippleThickness.value=m,r.uniforms.uRippleSpeed.value=h,r.uniforms.uEdgeFade.value=b,y?r.renderer.setClearAlpha(0):r.renderer.setClearColor(0,1),r.liquidEffect){let e=r.liquidEffect,t=e.uniforms.get(`uStrength`);t&&(t.value=l);let n=e.uniforms.get(`uFreq`);n&&(n.value=g)}r.touch&&(r.touch.radiusScale=u)}return E.current=D,()=>{if(T.current&&O||!T.current)return;let e=T.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===r&&r.removeChild(e.renderer.domElement),T.current=null}},[a,c,x,t,o,s,f,p,m,h,d,b,y,l,u,g,_,e,n,v]),(0,Yc.jsx)(`div`,{ref:S,className:`w-full h-full relative overflow-hidden ${r??``}`,style:i,"aria-label":`PixelBlast interactive background`})};export{il as default};